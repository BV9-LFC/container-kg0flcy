...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kg0flcy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kg0flcy.containers.anotherwebservice.com/
...
```
git clone git@github.com:BV9-LFC/container-kg0flcy.git
cd container-kg0flcy
```
...
```
docker attach container-kg0flcy
```
